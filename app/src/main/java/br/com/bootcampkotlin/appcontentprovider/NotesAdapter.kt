...
import br.com.bootcampkotlin.appcontentprovider.dataBase.NotesDataBaseHelper.Companion.DESCRIPTION_NOTES
...
class NotesViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
    ...
    val noteButtomRemove = itemView.findViewById<Button>(R.id.note_button_remove)
}